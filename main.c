...
int main()
{
	...
	//printf(" --- Return : %d\n", printf("%-2.a	, %.s, %-4s, %-2.4s, %-8.12s, %3s, %8s, %---2s, %.*s, %.0s, %.1s, %.2s, %.4s, %.8s", NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, -2, NULL, NULL, NULL, NULL, NULL, NULL));
	printf("%0d %i %s %c", -214748364, 12345, "hello world!", '\0');
	printf("\n");
	ft_printf("%0d %i %s %c", -214748364, 12345, "hello world!", '\0');
	printf("\n");
